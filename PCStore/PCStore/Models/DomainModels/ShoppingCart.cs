...
namespace PCStore.Models.DomainModels
{
    public class ShoppingCart
    {
        ...
        public void AddToCart(Product product, int amount)
        {
            ...
            var shoppingCartItem = _context.ShoppingCartItems.SingleOrDefault(s => s.Product.ProductId == product.ProductId 
                                                                                && s.ShoppingCartId == ShoppingCartId);

            // If the above was false, add the new product to the cart. Otherwise, increase the amount of the existing product
        ...
        {
            return ShoppingCartItems ?? (ShoppingCartItems = _context.ShoppingCartItems.Where(p => p.ShoppingCartId == ShoppingCartId)
        ...
        {
            var total = _context.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId).Select(c => c.Product.ProductPrice * c.Amount).Sum();
            return total;
        }
    }
}
